...
CREATE TABLE People (
  ...
  People_licence varchar(16) NOT NULL UNIQUE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE Vehicle (
  ...
  Vehicle_licence varchar(7) NOT NULL UNIQUE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
DROP TABLE IF EXISTS PoliceOffice;
...
INSERT INTO PoliceOffice (Username, Password, role) VALUES
('McNulty', 'plod123', 0),
('Moreland', 'fuzz42', 0),
('Daniels', 'copper99', 1);

ALTER TABLE PoliceOffice
